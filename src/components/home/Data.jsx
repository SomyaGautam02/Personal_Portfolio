...
const Data = () => {
  return (
    <div className="home__data">
      <h1 className="home__title">Somya Gautam
      <svg
                  width="36"
                  height="36"
                  viewBox="0 0 48 48"
      ...
      I am proactive problem solver and collaborative team player with a passion for creating captivating web experiences. Thrives in dynamic and innovative environments, continuously learning and growing :)
      </p>
      <a href="mailto:somyagautam02@gmail.com" className="button button--flex buttonhome">
        Say Hello
        <svg
                  class="button__icon"
                  xmlns="http://www.w3.org/2000/svg"
